...
public class IAKraken : IAAttacks
{
    ...
    public override void UseGroundAttacks()
    {
        ...
        if (relativeSideY >= -0.5f)
        {
            ...
            if (distanceX >= 2.5f)
            {
                if (relativeSideY < 1.5f && distanceX < 7.5f && rd.Next(0, 10) == 0) //1 chance sur 10
    ...
    public override void UseAirAttacks()
    {
        ...
        if (relativeSideY < -1.5f && distanceX < 0.75f && rd.Next(0, 3) == 0) //1 chance sur 3
    ...
    public override void UseGroundAttacksW()
    {
        ...
        if (relativeSideY >= -0.5f)
        {
            ...
            if (distanceX >= 2.5f)
            {
                if (relativeSideY < 1f && rd.Next(0, 7) == 0)
